          ...
          {selectedProject && selectedRow ? (
            <>
              ...
              <div className="project-action-groups">
                <button onClick={createProjectFollowUp} className={modeConfig.supportActionsSecondary ? 'action-btn' : 'primary-btn'}><FileText className="h-4 w-4" />New follow-up</button>
