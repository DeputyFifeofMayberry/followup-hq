  ...
  return (
    <header className="rounded-3xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Desktop follow-up command center</div>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">FollowUp HQ</h1>
          <p className="mt-2 max-w-3xl text-sm text-slate-600">
            One organized system for follow-ups, dropped emails, project action items, and running notes.
          </p>
        </div>
